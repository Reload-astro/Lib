local library = {
  ...
  if not isfolder("PPHUD") then
    ...
    local Arrow = request({Url = "https://raw.githubusercontent.com/Reload-astro/PPHud-Lib/main/Assets/Dropdown.png", Method = "GET"})
    writefile("PPHUD/Arrow.png", Arrow.Body)

    local Resize = request({Url = "https://raw.githubusercontent.com/Reload-astro/PPHud-Lib/main/Assets/resize.png", Method = "GET"})
